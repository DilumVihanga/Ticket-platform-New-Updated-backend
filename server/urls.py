...
from events.views import UserViewSet, CustomerProfileViewSet, OrganizerProfileViewSet , getEventsbyUser, getPurchasebyEvent
...
urlpatterns = [
    ...
    path('api/purchaseevent/<str:event_name>/', getPurchasebyEvent, name='rest_framework'),
